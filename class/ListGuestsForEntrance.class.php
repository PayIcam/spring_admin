...
require_once ROOT_PATH.'class/ListGuests.class.php';

/**
* Classe des ProgressBars pour le Gala
*/

class ListGuestsForEntrance extends ListGuests{

	const perPages = 10;

	function __construct($data=array()){
		$data['options']['fields'] = array('id','bracelet_id','prenom','nom','promo','is_icam','paiement','inscription','arrived','price', 'plage_horaire_entrees');
