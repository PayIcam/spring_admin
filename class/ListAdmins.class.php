...
<tr>
  ...
  <td>
    <div class="pull-right">
      <a href="admin_edit_admin.php?id=<?= $admin['id'] ?>" title="Editer l'admin #<?= $admin['id']; ?>"><i class="icon-pencil"></i></a>
      <a href="admin_liste_admins.php?del_admin=<?= $admin['id']; ?>&amp;token=<?= $token; ?>" title="Supprimer l'admin #<?= $admin['id']; ?>" onclick="return confirm('Voulez-vous vraiment supprimer ce admin ?');"><i class="icon-trash"></i></a>              
    </div>
  </td>
</tr>
	        	<?php
